...
parseExcel(`./files/Cardápio-${currentMonth}.xlsx`).forEach(element => {
    ...
    //console.log(Buffer.from('Ã–bert', 'utf-8').toString("utf8"))
    //console.log("Ã–bert".toString("utf8"))

    const File = xlsx.readFile(`./files/Cardápio-${currentMonth}.xlsx`, {type: "string"})
    //console.log(xlsx.utils.sheet_to_json(File.Sheets[File.SheetNames[0]]))
})
